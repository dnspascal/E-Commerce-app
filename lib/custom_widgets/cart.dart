...
class _Cart2State extends State<Cart2> {
  ...
  Widget build(BuildContext context) {
    ...
    return cartDetails.isEmpty ? Text("Your Cart Is empty") : SizedBox(
      height: 400,
        ...
        itemBuilder: (context, index) => Card(
          ...
          child: Column(
            ...
            children: [
              ...
              Image.asset(
               cartDetails.isEmpty ? "unknown" : cartProducts.cart[index].imageOfTheProduct,
                fit: BoxFit.fill,
                width: 150,
              ),
               Text(cartDetails.isEmpty ? "unknown" : cartProducts.cart[index].productName,
              ...
              //   height: 6,
              // ),
              Text(cartDetails.isEmpty ? "unknown" : cartProducts.cart[index].price,
                  style: const  TextStyle(
